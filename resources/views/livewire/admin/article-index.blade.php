...
<div class="w-full py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="w-full bg-zinc-900 rounded-xl shadow-2xl overflow-hidden p-6 border border-zinc-800">
        ...
        <form action="{{ route('admin.article.store') }}" method="POST" class="space-y-6" data-flux-component="form">
            @csrf
            <!-- Campo Nombre -->
            <div data-flux-field>
                ...
                <input type="text" id="nombre" name="nombre"
                    ...
                    placeholder="Ej: Paracetamol, Vitamina C" required data-flux-control>
                @error('nombre')
            ...
            <!-- Campo Descripción -->
            <div data-flux-field>
                <label for="descripcion" class="block text-sm font-medium text-zinc-300 mb-1" data-flux-label>
                    Contenido
                </label>
            ...
            <!-- Campo Precio -->
            <div data-flux-field>
                <label for="precio" class="block text-sm font-medium text-zinc-300 mb-1" data-flux-label>
